...
{
    public class CaseField : FieldBase<CaseFieldName, CaseField> {
        static CaseField()
        {
        ...
        public CaseField() {}
        private CaseField(CaseFieldName caseFieldName, FieldType fieldType, string fogBugzName) : base(caseFieldName, fieldType, fogBugzName)
        {
        }
